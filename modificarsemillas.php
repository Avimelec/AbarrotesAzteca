...
<?php
       ...
       $query = "SELECT * FROM ofertas_semana_semillas where clave = $clave";
       $resultado = $conexion->query($query);
       $row=$resultado->fetch_assoc();
		?>
<center>
	<form action="modificarsemillas_proceso.php?clave=<?php echo $row['clave']; ?>" method="POST" enctype="multipart/form-data">
