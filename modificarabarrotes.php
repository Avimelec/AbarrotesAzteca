...
<html>
<head>
	<title>OFERTAS DE ABARROTES</title>
</head>
<body>
...
<?php
       ...
       $query = "SELECT * FROM ofertas_semana_abarrotes where clave = $clave";
       $resultado = $conexion->query($query);
       $row=$resultado->fetch_assoc();
		?>
<center>
	<form action="modificarabarrotes_proceso.php?clave=<?php echo $row['clave']; ?>" method="POST" enctype="multipart/form-data">
